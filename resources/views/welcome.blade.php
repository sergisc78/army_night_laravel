...
<head>
   ...
   <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@700&family=Playfair+Display:ital@1&display=swap" rel="stylesheet">
            ...
            <div class="container-fluid" >
                ...
                <div class=" d-flex justify-content-between align-items-center " id="navbarColor02">
                    <ul class="navbar-nav me-auto  ">
                        ...
                        <a href="{{route('login')}}" class="btn btn-outline-primary btn-lg mr-3">Login</a>
