...
<body>
    ...
    <div class="bs-component">
        ...
        <div class="container" id="allbands">
            ...
            <a href="{{url('admin/add-genre')}}" class="btn btn-outline-primary mt-2 mb-4">Add a genre</a>
                    ...
                    <table id="table" class="table table-bordered display" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-outline-danger delete" data-id={{'/admin/genres/'.$genres->id}}>DELETE</button></td>
