    ...
    <div class="bs-component">
        ...
        <div class="container text-center">
            ...
            <div class="shadow p-3 mb-5 mt-4 rounded">
                <h1 class="text-center add mt-5"style="font-size:40px">Add Band</h1>
            <hr class="mt-4" style="background-color: whitesmoke">
                ...
                <form action="{{url('admin/saveBand')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="mt-5">
                        <label for="name">Band name</label>
                        <input type="text" name="band_name" id="inputs" placeholder="Type a name" style="color:black"
                            required>
                    </div>
                    <div class="mt-5">
                        <label for="name">Country</label>
                        <input type="text" name="band_country" id="inputs" placeholder="Type a country"
                            style="color:black" required>
                    </div>
                    <div class="mt-5">
                        <label for="name">Year creation</label>
                        <input type="text" name="band_year_creation" id="inputs" placeholder="Type a year"
                            style="color:black" required>
                    </div>
                    <div class="mt-5">
                        <label for="name">Band image</label>
                        <input type="file" name="band_image" id="band_image">
                    </div>
                    <div class="mt-3">
                        <button type="submit" class="btn btn-outline-success btn-add mt-4" type="button">Add band</button>
                    </div>
