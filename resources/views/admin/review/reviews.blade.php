...
<head>
    ...
    <title>Army of the night- Reviews </title>
...
<body>
    ...
    <div class="bs-component">
        ...
        <div class="container" id="allbands">
            ...
            <a href="{{url('admin/reviews/add-review')}}" class="btn btn-lg btn-outline-primary mt-2 mb-4">Add a
                review</a>
                    ...
                    <table id="table" class="table table-bordered display" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$reviews->album_year}}</td>
                                <td>{{$reviews->genre_name}}</td>
                                <td><img height="125px" src="{{ url('albumImages/'.$reviews->album_image)}}"
                                        alt="albumImages"></td>
                                ...
                                <td><a class="btn btn-outline-success btn-lg edit mb-3 "
                                        href="{{url('/admin/reviews/view-review/'.$reviews->id)}}">VIEW</a></td>

                                {{--EDIT LINK--}}

                                <td><a class="btn btn-outline-info btn-lg edit mb-3 "
                                        href="{{url('/admin/reviews/edit-review/'.$reviews->id)}}">EDIT</a></td>

                                {{--DELETE BAND --}}


                                <td><button class="btn btn-outline-danger delete"
                                        data-id={{'/admin/reviews/'.$reviews->id}}
