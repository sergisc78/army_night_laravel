...
<head>
    ...
    <title>Army of the Night - Edit Review </title>
    ...
    <div class="bs-component">
        ...
        <div class="container text-center">
            ...
            <div class="shadow p-3 mb-5 mt-4 rounded">
                ...
                <h1 class="text-center add mt-5" style="font-size:40px">Edit <br>{{$review->album_title}}</h1>
                ...
                <form action="{{url('admin/reviews/save-edit-review/'.$review->id)}}" method="post"
