...
<head>
  ...
  <title>Army of the night- Bands </title>
...
<body>
  ...
  <div class="bs-component">
    ...
    <div class="container" id="allbands">
      ...
      <a href="{{url('admin/bands/add-band')}}" class="btn btn-lg btn-outline-primary mt-2 mb-4">Add a band</a>
          ...
          <table id="table" class="table table-bordered display" width="100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><img height="100px" src="{{ url('bandImages/'.$bands->band_image)}}" alt="bandImages"></td>

                {{--EDIT LINK--}}

                <td><a class="btn btn-outline-info btn-lg edit mb-3 "
                    href="{{url('/admin/bands/edit-band/'.$bands->id)}}">EDIT</a></td>

                {{--DELETE BAND --}}


                <td><button class="btn btn-outline-danger delete" data-id={{'/admin/bands/'.$bands->id}}
