...
<body>
    ...
    <div class="bs-component">
       ...
       <a class="btn btn-outline-primary" href="{{url('admin/users')}}">Back</a>

       <div class="shadow p-3 mb-5 rounded" >
       
        <div class="container text-center">
            <h1 class="text-center add mt-5"style="font-size:40px">Edit User</h1>
            ...
            <form action="{{url('admin/users/save-edit-user/'.$user->id)}}" method="post" enctype="multipart/form-data" class="form">
                @csrf
                <div class="mt-5">
                    <label for="name">User</label>
                    <input type="text" name="name" id="inputs" value="{{$user->name}}" placeholder="Type a name" style="color:black" required>
                </div>
                <div class="mt-5">
                    <label for="name">Email</label>
                    <input type="email" name="email" id="inputs" value="{{$user->email}}" placeholder="Type a name" style="color:black" required>
                </div>
                <div class="mt-5">
                    <label for="name">Role</label>
                    <input type="text" name="usertype" id="inputs" value="{{$user->usertype}}" placeholder="Type a name" style="color:black" required>
                </div>
                
        
                <div class="mt-3">
                    <button type="submit" class="btn btn-outline-success btn-add mt-4" type="button">Edit user</button>
                </div>
