...
<body>
    ...
    <div class="bs-component">
        ...
        <div class="container text-center">
            ...
            <form action="{{url('admin/bands/save-edit-genre/'.$genre->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mt-5">
                ...
                <div class="mt-3">
                    <button type="submit" class="btn btn-outline-success btn-add mt-3" type="button">Edit band</button>
                </div>
