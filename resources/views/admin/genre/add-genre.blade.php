  ...
  <div class="bs-component">
    ...
    <div class="container text-center">
      <div class="shadow p-3 mb-5 mt-4 rounded">
        ...
        <a href="{{url('admin/genres/')}}" class="btn btn-lg btn-outline-primary mt-2 mb-4">Back</a>

        <h1 class="text-center add mt-5" style="font-size:40px">Add Genre</h1>
        ...
        <form action="{{url('admin/genres/saveGenre')}}" method="post" enctype="multipart/form-data">
          @csrf
          <div class="mt-5">
            <label for="name" class="mb-3">Genre name</label>
            <input type="text" name="genre_name" id="inputs" placeholder="Type a genre" style="color:black" required>
          </div>

          <div class="mt-4">
            <button type="submit" class="btn btn-outline-success btn-add mt-2" type="button">Add genre</button>
          </div>
